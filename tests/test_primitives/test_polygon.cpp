...
TEST_CASE("test_primitives/test_polygon | Draw a polygon", "[render/mock]") {
    auto poly = primitives::ConvexPolygon<math::Milimeters::symbol, mocks::DrawList>{};
    poly.filled = true;
    ...
    {
        auto line1 = std::make_shared<primitives::Line<math::Milimeters::symbol, mocks::DrawList>>();
        ...
        auto line2 = std::make_shared<primitives::Line<math::Milimeters::symbol, mocks::DrawList>>();
